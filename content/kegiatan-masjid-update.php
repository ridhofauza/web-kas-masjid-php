...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE kegiatan_masjid SET nama_kegiatan = ?, deskripsi = ?, tanggal_mulai = ?, tanggal_selesai = ?, lokasi = ?, dibuat_oleh = ? WHERE id_kegiatan = ?";
    $stmt = mysqli_prepare($con, $query);
    mysqli_stmt_bind_param($stmt, "sssssii", $nama_kegiatan, $deskripsi, $tanggal_mulai, $tanggal_selesai, $lokasi, $id_user, $id_kegiatan);
