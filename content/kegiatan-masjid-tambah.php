...
<section class="content">
    <div class="box box-body">
        <div class="box-header with-border">
            <h3 class="box-title">Tambah Kegiatan Masjid</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    <form action="?hal=kegiatan-masjid-insert" method="POST">
                        <div class="box-body">
                            <div class="form-group row" style="display: flex; align-items: center;">
                                <label for="nama_kegiatan" class="col-sm-2 col-form-label">Nama Kegiatan</label>
                                <div class="col-sm-6">
                                    <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" maxlength="255" required>
                                </div>
                            </div>
                            <div class="form-group row" style="display: flex; align-items: center;">
                            ...
                            <div class="form-group row" style="display: flex; align-items: center;">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="lokasi" id="lokasi" class="form-control" maxlength="255" required>
                                </div>
                            </div>
