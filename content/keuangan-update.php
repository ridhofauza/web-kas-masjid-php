...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $query = "UPDATE keuangan SET tanggal = ?, jenis = ?, jumlah = ?, sumber = ?, keterangan = ?, id_donasi = ?, id_kategori = ? WHERE id_keuangan = ?";
   $stmt = mysqli_prepare($con, $query);
   mysqli_stmt_bind_param($stmt, "ssissiii", $tanggal, $jenis, $jumlah, $sumber, $keterangan, $donasi, $kategori, $id_keuangan);
